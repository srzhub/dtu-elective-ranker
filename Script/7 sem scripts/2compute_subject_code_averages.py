...
'''
This script was used to compute the average gpa for each elective subject. This will be very helpful
data for all students in the college during course registration to pick their elective.
'''
