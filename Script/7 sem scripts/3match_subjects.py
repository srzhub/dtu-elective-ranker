...
We compiled average GPA for each subject code, but names could not be extracted due to structure of 
the pdf. We now parse through a different pdf from the college which contains many of the subject code
names with codes (but not all).
