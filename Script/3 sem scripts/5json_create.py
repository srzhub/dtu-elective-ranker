...
# === Configuration ===
SUMMARY_FILE = "final_3sem-2.csv"            # Must have: code, title, semester, count, avg_grade
GRADES_FILE  = "all_branches_results_2.csv"  # Must have: branch, RollNo, code, LetterGrade, grade
...
for code, group in df.groupby("code"):
    ...
    # Final payload now includes avg_grade
    data = {
        "code": code,
        "name": title,
        "semester": semester,
    ...
    out_path = OUTPUT_DIR / f"{code}_sem3.json"
