...
# === Configuration ===
SUMMARY_FILE = "final_1sem.xlsx"                 # Must have: code, title, semester, count, avg_grade
GRADES_FILE  = "all_branches_results_2.xlsx"      # Must have: branch, RollNo, code, LetterGrade, grade

OUTPUT_DIR = Path("json_data_1sem")
...
for code, group in df.groupby("code"):
    ...
    # Write to file
    out_path = OUTPUT_DIR / f"{code}_sem1.json"
