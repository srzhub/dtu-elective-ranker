...
# This is a slightly modified version of the 5 sem script, it compiles all subject first,
# then filters and keeps only subjects that 'AEC' or 'VAC' in their name
